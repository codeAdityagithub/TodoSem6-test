...
const Login = () => {
    ...
    return (
        // <>
            <form action="post" onSubmit={logindata} className="rounded-xl bg-gray-300 m-1 p-2 shadow-sm hover:bg-gray-400 max-w-[800px] w-auto flex flex-col justify-center text-blue-500">
                <div className="bg-slate-700 rounded-sm">
                <h1 className="text-orange-600 text-center font-semibold">Sign In</h1>
                </div>
                ...
                <button type="submit" className="bg-slate-700 rounded-md hover:cursor-pointer">LogIn</button>
            </form>
        // </>
    )
}
